// Centralised list of enums/constant tables used by the Limbar Remote Control
// package. Keeping them in one place allows them to be reused by headless SDKs
...
export const ANDROID_KEYS: { [k: string]: number } = {
  // Actions
  ACTION_DOWN: 0,
  ACTION_UP: 1,
...
export const codeMap: { [code: string]: number } = {
  ...
  'MetaLeft': ANDROID_KEYS.KEYCODE_META_LEFT, 'MetaRight': ANDROID_KEYS.KEYCODE_META_RIGHT,
  'ContextMenu': ANDROID_KEYS.MENU,
  // Numpad mappings
  ...
  'NumpadComma': ANDROID_KEYS.KEYCODE_NUMPAD_COMMA,
  'NumpadEnter': ANDROID_KEYS.KEYCODE_NUMPAD_ENTER,
  'NumpadEqual': ANDROID_KEYS.KEYCODE_NUMPAD_EQUALS,
};

export function getAndroidKeycodeAndMeta(event: React.KeyboardEvent): { keycode: number, metaState: number } | undefined {
